    ...
    <div class="section">
      <div class="container text-center">
        <div class="row justify-content-center">
          <ProfileCard  v-for="profile in allProfiles.slice(start,end)" :key="profile.id" :profile="profile"/>
        </div>
        <h4 v-if="noProfiles" class="card-title text-primary">{{$t('profiles.no-profiles')}}</h4>
      </div>
